...
/**
 * Entry point for the hospital management system application. Manages user
 * login and navigates to appropriate user-specific portals.
 */
public class Main {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (role != null) {
				...
				switch (role) {
				case "Administrator":
					Map<String, Administrator> admins = Administrator
							.loadAdministratorsFromCSV("data/Staff_Records.csv");
