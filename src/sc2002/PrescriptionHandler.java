...
/**
 * Handles prescription management, including viewing, updating, and managing
 * medicine stock and requests.
 */
public class PrescriptionHandler {
	...
	/**
	 * Displays a list of pending and dispensed prescriptions from the prescription
	 * CSV file.
	 */
	...
	/**
	 * Loads the name of a patient from the Patient_Records.csv based on the patient
	 * ID.
	 *
	 * @param patientID The ID of the patient.
	 * @return The patient's name or "Unknown Patient" if not found.
	 */
	...
	/**
	 * Loads the name of a doctor from the Staff_Records.csv based on the staff ID.
	 *
	 * @param staffID The ID of the doctor.
	...
	/**
	 * Updates the status of prescriptions in the prescription CSV file to
	 * "Dispensed".
	 *
	...
	/**
	 * Updates the stock of a specific medicine in the Medicine_Stock.csv file by
	 * deducting the quantity.
	 *
	 * @param prescriptionName  The name of the medicine to update.
	 * @param quantityRequested The amount of stock to deduct.
	 * @return True if the stock was successfully updated, false if not enough stock
	 *         was available.
	 */
	...
	/**
	 * Updates the prescription status in the Patient_Diagnosis_Prescription.csv
	 * file.
	 *
	 * @param appointmentID The ID of the appointment to update.
	 * @param newStatus     The new status to set (e.g., "Dispensed").
	 */
	...
	/**
	 * Displays a warning message for any medicines running low in stock based on
	 * the threshold.
	 */
	...
	/**
	 * Displays the current stock of all medicines from the Medicine_Stock.csv file.
	 */
	 ...
	 *
	 * @param scanner A Scanner object for user input.
	 * @param staffId The ID of the staff member submitting the request.
	 */
	...
	/**
	 * Writes a replenishment request to the Medicine_Request.csv file.
	 *
	 * @param medicineName      The name of the medicine to replenish.
	 * @param requestedQuantity The quantity to request.
	...
	/**
	 * Retrieves a list of available medicines from the stock file.
	 *
	...
	/**
	 * Displays all medicine replenishment requests from the Medicine_Request.csv
	 * file.
	 */
	...
	/**
	 * Approves a pending replenishment request and updates the Medicine_Request.csv
	 * file and stock.
	 *
	 * @param scanner A Scanner object for user input.
	 * @param adminID The ID of the administrator approving the request.
	 */
	...
	/**
	 * Adds stock to a specific medicine in the Medicine_Stock.csv file.
	 *
	 * @param medicineName  The name of the medicine to add stock to.
	 * @param quantityToAdd The quantity of stock to add.
	 */
