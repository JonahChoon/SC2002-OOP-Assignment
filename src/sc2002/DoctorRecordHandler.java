...
/**
 * Handles operations related to doctor records, including retrieval and
 * updates.
 */
public class DoctorRecordHandler {

	/**
	 * Displays all patients under the care of a specific doctor, along with their
	 * medical history.
	 *
	...
	/**
	 * Allows a doctor to update a patient's medical record by selecting an
	 * appointment ID.
	 *
	 * @param doctorID The ID of the doctor.
	...
	/**
	 * Updates a patient's medical record in the CSV file with new details.
	 *
	 * @param patientID     The ID of the patient.
	 * @param appointmentID The ID of the appointment to be updated.
	 * @param newService    The new type of service, if applicable.
	 * @param newDiagnosis  The new diagnosis, if applicable.
	 * @param newTreatment  The new treatment, if applicable.
	 * @param newCaseNotes  The new case notes, if applicable.
	 */
	private static void updateMedicalRecordInCSV(String patientID, String appointmentID, String newService,
		...
		if (recordUpdated) {
			try (BufferedWriter writer = new BufferedWriter(
					new FileWriter("data/Patient_Diagnosis_Prescription.csv"))) {
	...
	/**
	 * Displays the availability of a specific doctor by reading from the CSV file.
	 *
	 * @param doctorID The ID of the doctor.
	 */
	...
	/**
	 * Allows a doctor to set their availability by specifying a date and time
	 * range.
	 *
	 * @param doctorID The ID of the doctor.
	 * @param scanner  A Scanner object for reading user input.
	...
	/**
	 * Displays pending appointments for a doctor and allows approval or disapproval
	 * of the appointments.
	 *
	 * @param doctorID The ID of the doctor.
	 * @param scanner  A Scanner object for reading user input.
	...
	public static void approveOrDisapproveAppointments(String doctorID, Scanner scanner) {
		...
		// Read from Patient_Appointment.csv to find pending appointments for the given
		// doctor
		...
		String[] selectedAppointment = pendingAppointments.stream().filter(app -> app[0].equals(selectedAppointmentID))
	 ...
	 *
	 * @param appointmentID The ID of the appointment to be updated.
	 * @param newStatus     The new status of the appointment (e.g., "Confirmed",
	 *                      "Cancelled by Doctor").
	 */
