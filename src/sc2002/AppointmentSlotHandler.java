...
/**
 * This class handles various operations related to appointment slots, including
 * viewing, scheduling, rescheduling, and cancelling appointments. It interacts
 * with CSV files for storing and retrieving appointment data.
 */
public class AppointmentSlotHandler {
	...
	/**
	 * Displays available appointment slots for the user.
	 *
	 ...
	 *
	 * @param scanner A {@code Scanner} object for reading user input.
	 * @param patient The {@code Patient} object for whom the appointment is being
	 *                scheduled.
	 */
	...
	/**
	 * Saves the appointment to the file and marks the timeslot as "Unavailable".
	 *
	 * @param patient  The {@code Patient} object.
	 * @param doctorID The ID of the doctor.
	 * @param date     The date of the appointment.
	 * @param timeSlot The selected time slot for the appointment.
	 */
	...
	/**
	 * Generates a new appointment ID based on the last ID in the CSV file.
	 *
	 ...
	 *
	 * @return A map containing doctor availability.
	 */
	...
	/**
	 * Loads the names of doctors from a CSV file containing staff records.
	 *
	 * @return A map where the key is the doctor ID and the value is the doctor's
	 *         name.
	 */
	...
	/**
	 * Displays the availability of doctors along with their available dates.
	 *
	 * @param doctorAvailabilityMap A map containing doctor availability details.
	 * @param doctorNames           A map containing doctor IDs and their
	 *                              corresponding names.
	 * @param sortedDoctorIDs       A list of sorted doctor IDs for display.
	 */
	...
	/**
	 * Displays the available time slots for a specific doctor on a given date.
	 *
	 * @param doctorAvailability The availability details of the doctor.
	 * @param date               The date for which time slots are displayed.
	 * @param timeSlots          A list of available time slots.
	 * @param doctorNames        A map containing doctor IDs and their corresponding
	 *                           names.
	 */
	...
	/**
	 * Updates the availability status of a doctor's time slot in the CSV file.
	 *
	 * @param doctorID The ID of the doctor.
	 * @param date     The date of the appointment.
	 * @param timeSlot The time slot to be updated.
	 */
	...
	/**
	 * Displays upcoming appointments for the given patient.
	 * 
	 * @param scanner A {@code Scanner} object for reading user input.
	 * @param patient The {@code Patient} object whose appointments are being
	 *                viewed.
	 */
	...
	/**
	 * Reschedules an existing appointment by selecting a new date and time slot.
	 * 
	 * @param scanner A {@code Scanner} object for reading user input.
	 * @param patient The {@code Patient} object whose appointment is being
	 *                rescheduled.
	 */
	...
	/**
	 * Updates an appointment with new details and saves the changes to the CSV
	 * file.
	 * 
	...
	/**
	 * Updates the availability status of a specific time slot for a doctor in the
	 * CSV file.
	 * 
	 * @param doctorID  The ID of the doctor.
	 * @param date      The date of the time slot.
	 * @param timeSlot  The specific time slot to update.
	 * @param newStatus The new status (e.g., "Available", "Unavailable").
	 */
	...
	/**
	 * Cancels an existing appointment for a patient and updates the CSV file.
	 * 
	 * @param scanner A {@code Scanner} object for reading user input.
	 * @param patient The {@code Patient} object whose appointment is being
	 *                cancelled.
	...
	/**
	 * Updates the status of an appointment to "Cancelled by Patient" in the CSV
	 * file.
	 * 
	...
	/**
	 * Loads the name of a doctor based on their ID from the staff records CSV.
	 * 
	 * @param doctorID The ID of the doctor.
	...
	/**
	 * Loads diagnosis details for a specific patient ID from the diagnosis CSV
	 * file.
	 * 
	 * @param patientID The ID of the patient.
	 * @return A map containing diagnosis details, mapped by appointment ID.
	 */
	...
	/**
	 * Displays all appointments and outcomes for the specified patient.
	 * 
	 * @param scanner A {@code Scanner} object for reading user input.
	 * @param patient The {@code Patient} object whose appointments are being
	 *                viewed.
	...
	/**
	 * Displays a list of appointments with basic details.
	 * 
	 * @param appointments A list of appointments to display.
	 */
	...
	/**
	 * Displays completed appointments along with detailed diagnosis information.
	 * 
	 * @param appointments A list of completed appointments.
	 * @param diagnosisMap A map of diagnosis details, mapped by appointment ID.
	 */
	...
	/**
	 * Prints the details of a single appointment.
	 * 
	...
	/**
	 * Displays the upcoming appointments for a specific doctor.
	 * 
	 * @param doctorID The ID of the doctor.
	 */
	...
	/**
	 * Records the outcome of an appointment for a specified doctor.
	 * 
	 * @param doctorID The ID of the doctor.
	 * @param scanner  A {@code Scanner} object for reading user input.
	 */
	public static void recordAppointmentOutcome(String doctorID, Scanner scanner) {
		...
		if (!typeOfService.equalsIgnoreCase("Consultation") && !typeOfService.equalsIgnoreCase("X-ray")
	...
	/**
	 * Updates the outcome of an appointment in the CSV file.
	 * 
	 * @param appointmentID The ID of the appointment.
	 * @param newOutcome    The new outcome status (e.g., "Completed").
	 */
	...
	/**
	 * Loads patient names from the Patient Records CSV.
	 * 
	 * @return A map of patient IDs and their corresponding names.
	 */
	...
	/**
	 * Loads available medicines from the medicine stock CSV.
	 * 
	 * @return A list of available medicine names.
	 */
	...
	/**
	 * Appends diagnosis details to the diagnosis CSV file.
	 * 
	 * @param patientID     The ID of the patient.
	 * @param date          The date of the diagnosis.
	 * @param diagnosis     The diagnosis description.
	 * @param treatment     The treatment provided.
	 * @param prescription  The prescribed medication.
	 * @param quantity      The quantity of the prescription.
	 * @param caseNotes     Case notes from the diagnosis.
	 * @param doctorID      The ID of the doctor.
	 * @param appointmentID The ID of the appointment.
	 * @param typeOfService The type of service provided (e.g., "Consultation").
	 */
	...
	/**
	 * Displays all appointments and outcomes for admin access.
	 * 
	 * @param scanner A {@code Scanner} object for reading user input.
	 */
		...
		try (BufferedReader br = new BufferedReader(new FileReader("data/Patient_Diagnosis_Prescription.csv"))) {
			...
			while ((line = br.readLine()) != null) {
				...
				diagnosisDetailsByPatient.get(patientID).put(data[9].trim(), // Appointment ID
						new String[] { data[2].trim(), data[3].trim(), data[4].trim(), data[5].trim(), data[6].trim(),
								data[10].trim() });
			}
		} catch (IOException e) {
			e.printStackTrace();
			...
			while ((line = br.readLine()) != null) {
				...
				if ((status.equalsIgnoreCase("Confirmed") || status.equalsIgnoreCase("Pending"))
					...
					upcomingAppointments
							.add(new String[] { appointmentID, patientID, doctorID, date, timeSlot, status });
				} else if (status.contains("Cancelled")) {
	...
	/**
	 * Displays a list of appointments for admin with patient names.
	 * 
	 * @param appointments A list of appointments to display.
	 * @param patientNames A map of patient IDs to their names.
	 */
	...
	/**
	 * Displays completed appointments with diagnosis details for admin.
	 * 
	 * @param appointments              A list of completed appointments.
	 * @param patientNames              A map of patient IDs to their names.
	 * @param diagnosisDetailsByPatient A map of diagnosis details by patient ID and
	 *                                  appointment ID.
	 */
	private static void displayCompletedAppointmentsForAdmin(List<String[]> appointments,
			Map<String, String> patientNames, Map<String, Map<String, String[]>> diagnosisDetailsByPatient) {
		for (String[] appointment : appointments) {
			String appointmentID = appointment[0];
			String patientID = appointment[1];
			String doctorID = appointment[2];
